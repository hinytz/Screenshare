...
const strings = {
  en: {
    ...
    kind_screenshare_blurb: 'Share your screen or camera with up to 5 people. You can start a watch party too.',
    kind_watchparty: 'Watch party',
    kind_watchparty_blurb: 'Watch YouTube, Twitch, or a video together. No screen share or camera. No join limit. Chat and mic stay on.',
    watch: 'Watch',
  ...
  pt: {
    ...
    kind_screenshare: 'Screenshare',
    kind_screenshare_blurb: 'Compartilhe tela ou câmera com até 5 pessoas. Dá para abrir um watch party também.',
    kind_watchparty: 'Watch party',
    kind_watchparty_blurb: 'Assista YouTube, Twitch ou um vídeo juntos. Sem tela ou câmera. Sem limite de pessoas. Chat e microfone continuam.',
    watch: 'Assistir',
    watch_party: 'Watch party',
