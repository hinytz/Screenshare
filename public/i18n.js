...
const strings = {
  en: {
    ...
    create: 'Create',
    room: 'Room',
    room_placeholder: 'my-room',
    invite_code: 'Invite code',
    invite_placeholder: 'JyW5XrNwb',
    public_room: 'Public',
    private_room: 'Private',
    room_visibility: 'Room visibility',
    text_category: 'Text',
    voice_category: 'Voice',
    add_text_channel: 'Add text channel',
    add_voice_channel: 'Add voice channel',
    rename_channel: 'Rename channel',
    delete_channel: 'Delete channel',
    delete_channel_confirm: 'Are you sure you want to delete {name}?',
    channel_last: 'Keep at least one channel of that type.',
    disconnect_voice: 'Disconnect',
    join_requests: 'Join requests',
    allow: 'Allow',
    deny: 'Deny',
    voice_full: 'That voice channel is full.',
    join_pending: 'Waiting for the owner to approve.',
    join_denied: 'The owner denied this request.',
    join_private: 'This room is private. Request access.',
    channel_limit: 'Channel limit reached.',
    channel_fail: 'Could not update that channel.',
    channel_exists: 'That channel name is taken.',
    visibility_bad: 'Choose public or private.',
    password: 'Password',
    username: 'Username',
    enter: 'Enter',
    continue: 'Continue',
    ...
    room_type: 'Room type',
    kind_screenshare: 'Screenshare',
    kind_screenshare_blurb: 'Share your screen or camera in a voice channel. You can start a watch party too.',
    kind_watchparty: 'Watch party',
    kind_watchparty_blurb: 'Watch YouTube, Twitch, or a video together. No screen share or camera. Chat and mic stay on.',
    watch: 'Watch',
    watch_party: 'Watch party',
    watch_url: 'Video link',
    watch_url_placeholder: 'YouTube, Twitch live, HLS, or a direct video URL',
    watch_start: 'Start watching',
    watch_stop: 'Stop watching',
    watch_host: 'Host',
    watch_make_host: 'Make host',
    watch_now_host: 'Now hosting',
    watch_twitch: 'Live on Twitch',
    watch_live: 'Live',
    watch_bad_url: 'Could not use that link.',
    watch_clip: 'Twitch clips are not compatible.',
    watch_vod: 'Twitch VODs are not compatible.',
    watch_media_fail: 'Could not play that file. The site may block it.',
    watch_hls_fail: 'Could not play that stream.',
    watch_forbidden: 'Only the host can do that.',
    watch_missing: 'Start a watch party first.',
    watch_fail: 'Could not update watch party.',
    room_kind_bad: 'Invalid room type.',
    ...
    connected_to_voice: 'Connected to voice',
    close: 'Close',
    send: 'Send',
    ...
    enter_fields: 'Enter a room name or invite code, and a username.',
    room_exists: 'Room already exists',
    room_not_found: 'Room not found.',
    room_tag_required: 'Include the room tag, e.g. room#abcd.',
    wrong_password: 'Wrong password.',
    room_full: 'That voice channel is full',
  ...
  pt: {
    ...
    text_category: 'Texto',
    voice_category: 'Voz',
    add_text_channel: 'Adicionar canal de texto',
    add_voice_channel: 'Adicionar canal de voz',
    rename_channel: 'Renomear canal',
    delete_channel: 'Apagar canal',
    delete_channel_confirm: 'Tem certeza de que deseja apagar {name}?',
    channel_last: 'Mantenha pelo menos um canal desse tipo.',
    disconnect_voice: 'Desconectar',
    join_requests: 'Pedidos para entrar',
    allow: 'Permitir',
    deny: 'Recusar',
    voice_full: 'Esse canal de voz está cheio.',
    join_pending: 'Esperando o dono aprovar.',
    join_denied: 'O dono recusou este pedido.',
    join_private: 'Esta sala é privada. Peça acesso.',
    channel_limit: 'Limite de canais atingido.',
    channel_fail: 'Não foi possível atualizar o canal.',
    channel_exists: 'Esse nome de canal já existe.',
    visibility_bad: 'Escolha pública ou privada.',
    password: 'Senha',
    username: 'Usuário',
    enter: 'Entrar',
    continue: 'Continuar',
    ...
    kind_screenshare: 'Screenshare',
    kind_screenshare_blurb: 'Compartilhe tela ou câmera em um canal de voz. Dá para abrir um watch party também.',
    kind_watchparty: 'Watch party',
    kind_watchparty_blurb: 'Assista YouTube, Twitch ou um vídeo juntos. Sem tela ou câmera. Chat e microfone continuam.',
    watch: 'Assistir',
    watch_party: 'Watch party',
    watch_url: 'Link do vídeo',
    watch_url_placeholder: 'YouTube, Twitch ao vivo, HLS ou um URL direto de vídeo',
    watch_start: 'Começar a assistir',
    watch_stop: 'Parar de assistir',
    watch_host: 'Host',
    watch_make_host: 'Tornar host',
    watch_now_host: 'Você é o host',
    watch_twitch: 'Ao vivo no Twitch',
    watch_live: 'Ao vivo',
    watch_bad_url: 'Não foi possível usar esse link.',
    watch_clip: 'Clipes do Twitch não são compatíveis.',
    watch_vod: 'VODs do Twitch não são compatíveis.',
    watch_media_fail: 'Não foi possível reproduzir esse arquivo. O site pode estar bloqueando.',
    watch_hls_fail: 'Não foi possível reproduzir essa transmissão.',
    watch_forbidden: 'Só o host pode fazer isso.',
    watch_missing: 'Comece um watch party primeiro.',
    watch_fail: 'Não foi possível atualizar o watch party.',
    room_kind_bad: 'Tipo de sala inválido.',
    ...
    chat_channel: 'Chat',
    members: 'Membros',
    channels_menu: 'Canais',
    settings: 'Configurações',
    join_voice: 'Entrar na voz',
    connected_to_voice: 'Conectado à voz',
    close: 'Fechar',
    send: 'Enviar',
    ...
    copied: 'Copiado',
    copy_fail: 'Não foi possível copiar o link.',
    kicked: 'Você foi removido da sala.',
    enter_fields: 'Informe o nome da sala ou o código de convite, e um usuário.',
    room_exists: 'A sala já existe',
    room_not_found: 'Sala não encontrada.',
    room_tag_required: 'Inclua a tag da sala, por exemplo sala#abcd.',
    wrong_password: 'Senha incorreta.',
    room_full: 'Esse canal de voz está cheio',
