...
const SCHEMA_SQL = `
  ...
  CREATE INDEX IF NOT EXISTS room_members_room ON room_members (room_id, username_key);
  CREATE UNIQUE INDEX IF NOT EXISTS room_members_guest_name
    ON room_members (room_id, username_key) WHERE user_id IS NULL;
...
function applySchema(db) {
  ...
  db.exec('DROP INDEX IF EXISTS room_members_name');
  db.exec(SCHEMA_SQL);
}
